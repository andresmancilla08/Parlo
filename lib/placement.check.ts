...
assert.equal(nextLevel("C2"), null, "C2 es el último nivel con contenido");
...
// Todo bien → C2 (es el nivel más alto con contenido hoy).
const full = placementResult(answersFor(["A1", "A2", "B1", "B2", "C1", "C2"], () => true));
assert.equal(full.level, "C2");
