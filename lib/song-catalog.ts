...
// la dicción, vocabulario), no la dificultad musical. 12 canciones por nivel.
...
export const SONG_SUGGESTIONS: SongSuggestion[] = [
  ...
  { id: "s-count-on-me", title: "Count on Me", artist: "Bruno Mars", year: 2010, level: "A1", why: "Condicional sencillo y vocabulario de amistad." },
  ...
  { id: "s-lemon-tree", title: "Lemon Tree", artist: "Fool's Garden", year: 1995, level: "A1", why: "Presente simple y vocabulario básico de rutina." },
  ...
  { id: "s-easy-on-me", title: "Easy on Me", artist: "Adele", year: 2021, level: "A2", why: "Lenta, con imperativos y vocabulario emocional." },
  ...
  { id: "s-sugar", title: "Sugar", artist: "Maroon 5", year: 2014, level: "A2", why: "Presente simple y expresiones de necesidad." },
  ...
  { id: "s-fix-you", title: "Fix You", artist: "Coldplay", year: 2005, level: "B1", why: "Oraciones con «when» y vocabulario emocional." },
  ...
  { id: "s-i-will-survive", title: "I Will Survive", artist: "Gloria Gaynor", year: 1978, level: "B1", why: "Futuro con «will» y pasado, velocidad media." },
  ...
  { id: "s-rocket-man", title: "Rocket Man", artist: "Elton John", year: 1972, level: "B2", why: "Vocabulario poético y frases partidas." },
  { id: "s-superstition", title: "Superstition", artist: "Stevie Wonder", year: 1972, level: "B2", why: "Funk rápido con expresiones poco literales." },
];
